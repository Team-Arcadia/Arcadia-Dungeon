...
public class PlayerProgress {
    ...
    public static class ArcadiaProgress {
        ...
        public Set<Integer> claimedMilestoneLevels = ConcurrentHashMap.newKeySet();
    }
    ...
    public boolean normalize() {
        ...
        if (arcadiaProgress.claimedMilestoneLevels == null) {
            arcadiaProgress.claimedMilestoneLevels = ConcurrentHashMap.newKeySet();
            changed = true;
        }
        return changed;
    }
